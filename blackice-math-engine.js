...
(function() {
    ...
    window.BlackIceMath = {
        ...
        pay:          { TABLE: PAYTABLE, get LINES(){ return PAYLINES; }, NUM_LINES: function(){ return NUM_PAYLINES; }, BET_LEVELS: function(){ return BET_LEVELS; }, DEFAULT_BET: function(){ return DEFAULT_BET; }, getSymbolPay: function(n,c){ if(c<3||c>5)return 0; var e=PAYTABLE[n]; return e?e[c-3]:0; } },
        ...
        bonus:        { FIREBALL_CHANCE: BONUS_FIREBALL_CHANCE, get INITIAL_FIREBALLS(){ return BONUS_INITIAL_FIREBALLS; }, RESPINS: BONUS_RESPINS, rollNextTrigger: rollNextBonusTrigger, randomFireballValue: randomFireballValue, initGrid: initBonusGrid, resolveRespin: resolveBonusRespin },
